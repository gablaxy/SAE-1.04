...
INSERT INTO DETAILCOMMANDE (a 3.2 çNUMCOMMANDE, NUMARTICLE, QUANTITECOMMANDEE, QUANTITELIVREE) values (24,9,20,22);
...
create table CLIENT (
    ...
    constraint PK_CLIENT_NUMCLIENT primary key0 (NUMCLIENT)   
);
...
create table SEDECOMPOSE(
    ...
    LIBELLECATEGORIE    varchar(40) not null,
    constraint PK_SEDECOMPOSE primary key(CAT_NUMCATEGORIE2, LIBELLECATEGORIE)
);
